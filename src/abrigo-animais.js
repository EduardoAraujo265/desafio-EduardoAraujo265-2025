class AbrigoAnimais {
  encontraPessoas(brinquedosPessoa1, brinquedosPessoa2, ordemAnimais) {
    ...
    if (
      brinquedo1.every((brinquedo) => brinquedosValidos.includes(brinquedo))
    ) {
    } else {
      return (resultado = {
    ...
    if (
      brinquedo2.every((brinquedo) => brinquedosValidos.includes(brinquedo))
    ) {
    } else {
      return {
        erro: "Brinquedo inválido",
      ...
      nomeAnimal.forEach((element, index) => {
        ...
        brinquedo1.forEach((elements, indice) => {
          if (nomeAnimal[index].animal === "jabuti" && animaisAdotados > 0) {
            if (nomeAnimal[index].brinquedo.includes(elements)) {
              quantidadeBrinquedosCompativeis2++;
              if (
                quantidadeBrinquedosCompativeis2 === element.brinquedo.length
              ) {
            ...
            if (
              nomeAnimal[index].brinquedo[quantidadeBrinquedosCompativeis1] ===
              elements
            ) {

              quantidadeBrinquedosCompativeis1++;
              if (
                quantidadeBrinquedosCompativeis1 === element.brinquedo.length
              ) {
                adotavelPessoa1 = true;
              }
            }
        ...
        brinquedo2.forEach((brinquedo, indice) => {
          if (nomeAnimal[index].animal === "jabuti" && animaisAdotados > 0) {
            if (nomeAnimal[index].brinquedo.includes(brinquedo)) {
              quantidadeBrinquedosCompativeis2++;
              if (
                quantidadeBrinquedosCompativeis2 === element.brinquedo.length
              ) {
            ...
            if (
              nomeAnimal[index].brinquedo[quantidadeBrinquedosCompativeis2] ===
              brinquedo
            ) {
              quantidadeBrinquedosCompativeis2++;
              if (
        ...
        if (animaisAdotados < 3) {
          ...
          if (!adotavelPessoa1 && !adotavelPessoa2) {
            ...
            if (nomeAnimal[index].animal === "gato") {
                brinquedo1.forEach((elements, indice, brinquedoI) => {
                  if (nomeAnimal[index].brinquedo.includes(elements)){
                brinquedoI[indice] = "brinquedo tomado pelo gato!";}
                });}
            resultado.lista.unshift(`${nomeAnimal[index].nome} - pessoa 1`);
            animaisAdotados++;
          } else {
              if (nomeAnimal[index].animal === "gato") {
                brinquedo2.forEach((elements, indice, brinquedoI) => {
                  if (nomeAnimal[index].brinquedo.includes(elements)){
                brinquedoI[indice] = "brinquedo tomado pelo gato!";}
                });
              }
